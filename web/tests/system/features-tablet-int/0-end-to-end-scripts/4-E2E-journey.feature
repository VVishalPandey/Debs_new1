...
Scenario Outline: Validate the shop more tags and select Cups & saucers tag to navigate to psp page
  ...
  Then I should see "headerText" as "Keep Cup" on "pspPage"
  And I should see "url" contains "en-au/keep-cup"
...
Scenario: Select the first product save its detail and add to bag
  ...
  And I should see "addToBagRemainingText" containing "added to your bag" on "pdpPage"
