...
Scenario: Validate the colour changes of sale text and icons in menu
  ...
  And I should see "StoreLocatorIcon" "#000000" in colour
  And I should see "PersonalFinanceicon" "#000000" in colour
  And I should see "BeautyClucbIcon" "#000000" in colour
