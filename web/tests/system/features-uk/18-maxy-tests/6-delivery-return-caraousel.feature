...
Scenario: Validate add Value proposition bar on home page with Variant 1
  ...
  And I should see "Free standard delivery" option should contain text "on orders £50 or over"
  And I should see "Free standard delivery icon" on first option
  Then I scroll to "2nd Option"
  And I should see "2nd option " as "Free delivery"  on "homePage"
  And I should see "Free delivery" option should contain text "on all click and collect order"
  And I should see "Free delivery icon" on first option
  ...
  When I click on "Free delivery"  on "homePage"
  Then I should be redirected to "Click and collect FAQ page"
