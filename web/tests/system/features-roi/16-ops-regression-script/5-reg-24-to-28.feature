...
Scenario Outline: Validate swatchis ordered when user enters address and selects a swatch
  ...
  Examples:
    ...
    | Vishal    | Malhotra | vmalhotra9918@sapient.com | Flat 31     | The Lock Building | High Street, Stratford | London | V94D2F9  |
