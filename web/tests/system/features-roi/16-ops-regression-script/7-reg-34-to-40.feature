...
@automated @ops-ROI @checkout-J @Sno.-34
...
@automated @ops-ROI @checkout-J @Sno.-35
...
@automated @ops-ROI @checkout-J @Sno.-36
...
@automated @ops-ROI @checkout-J @Sno.-37 @deprecated
...
@automated @ops-ROI @checkout-J @Sno.-37
Scenario: Navigate to delivery page, validate that Click & Collect delivery option is not available and slect Home delivery
  ...
  When I select home delivery and provide IE address details and navigate to delivery options under it
  Then I should see "disabledOption" as "Next Day Delivery" on "deliveryOptionPage"
...
@automated @ops-ROI @checkout-J @Sno.-38
...
@automated @ops-ROI @checkout-J @Sno.-39
...
@automated @ops-ROI @checkout-J @Sno.-40
