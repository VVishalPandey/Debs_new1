...
Scenario: Verify the production description and each item listed with short description, price, size selector, quantity selector & add to bag button is displayed
  ...
  Then I should see "productDescAccordion" exist on "pdpPage"
...
@automated @ops-ROI @MiniBag @Sno.-31
...
@automated @ops-ROI @MyBag @Sno.-31
...
@automated @ops-ROI @MyBag @Sno.-32
...
@automated @ops-ROI @MyBag @Sno.-33
