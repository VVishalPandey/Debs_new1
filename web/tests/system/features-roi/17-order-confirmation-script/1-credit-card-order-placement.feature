...
Scenario Outline: Validate order confirmation page with non 3DS cards payments
  ...
  Examples:
    ...
    |nextDayDeliveryPdpURL  |Next      |Credit   |340000000001064| 1234          | american-express     |
...
Scenario Outline: Validate order confirmation page with V1 & V2 3DS cards payments
  ...
  And I should see "threeDSProgressNotification" as "Please don't close or refresh this window." on "paymentPage"
