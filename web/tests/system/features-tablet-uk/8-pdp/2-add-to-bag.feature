...
@automated @Fixed @DBMTE-33 @DBMTE-48 @DBMTE-35
Scenario: Navigate to Beauty - Make Up page and validate colour swatches and drop down for product "Lipstick"
  Given I logout
  And I navigate to "beautyLipstickPdpUrl"
  When I should see "beautyColourSwatches" exist on "pdpPage"
  And I should validate minibag count "before"
  And I should see selected colour as "Cherry"
  And I select available colour "2" as "Devilish" from "colourSwatch"
  And I should see selected colour as "Devilish"
  Then I should see "colourDropDown" exist on "pdpPage"
  And I should see selected colour as "Devilish"
  Then I select available colour "3" as "Juicy" from "colourSwatch"
  And I should see selected colour as "Juicy"
...
@automated @Fixed @DBMTE-33 @DBMTE-48 @DBMTE-35 @DBMTE-39
Scenario: Navigate to beauty product with free gift badging
  Given I navigate to "freeGiftPdpURL"
  And I should validate minibag count "before"
...
@automated @Fixed @DBMTE-33 @DBMTE-48 @DBMTE-35 @DBMTE-52
...
@notautomated @DBMTE-33 @DBMTE-48 @DBMTE-35 @DBMTE-57 @dataNA @depracated
