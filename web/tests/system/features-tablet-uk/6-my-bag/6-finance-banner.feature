...
Scenario: Validate Private Sale banner copy from "https://debenhams.invisionapp.com/share/4ZKN2XRCS3P" for tablet

@manual @DDAI-850 @DDAI-944 @DDAI-1000
Scenario: Validate default banner copy from "https://debenhams.invisionapp.com/share/4ZKN2XRCS3P" for tablet

@manual @DDAI-850 @DDAI-944 @DDAI-1000
Scenario: Validate recruitment banner copy from "https://debenhams.invisionapp.com/share/4ZKN2XRCS3P" for tablet
