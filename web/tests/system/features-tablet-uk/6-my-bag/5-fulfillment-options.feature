...
Scenario: Navigate to Debenhams my bag page with a furniture added from above scenario and validate text of all available fullfillment options
  When I click and validate "Standard" fullfillment option text as "Standard delivery of this product will be within 9 weeks (£3.49),  free on orders £45 or over" on myBagPage
