...
@manual @DEBD-3992
Scenario: validate new Beauty spots component  on home Page in portrait mode
  ...
  And I should see that the beauty offers are aligned horizontally
...
@manual @DEBD-3992
Scenario: validate new Beauty spots component  on home Page in Lanscape mode
  Given I am on "homePage"
  When I scroll past the first banner after hero component on "home Page"
  Then I should see "Beauty spots component" exists on "home Page"
  And I should see one row of Beauty spots
