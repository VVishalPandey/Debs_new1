...
@automated @ops-TABLET @HomePage @Sno.-1
...
@automated @ops-TABLET @HomePage @Sno.-3 @Sno.-4
...
@automated @ops-TABLET @HomePage @Sno.-5
Scenario: Validate GDPR cookie banner 'Accept cookie' functionality
  ...
  Then I should see value of position "4" as "Maxi dresses"
  When I click on "Maxi dresses" position "4"
...
@automated @ops-TABLET @HomePage @Sno.-2
 Scenario: Validate the Global menu options for signed in user
  ...
  And I should see "menuIcon" exist on "commonPage"
  #Then I click on "menuIcon" on "commonPage"
...
@automated @ops-TABLET @HomePage @Sno.-6
...
@automated @ops-TABLET @HomePage @Sno.-7
