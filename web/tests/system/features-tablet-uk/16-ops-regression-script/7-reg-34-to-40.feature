...
@automated @ops-TABLET @checkout-J @Sno.-34
Scenario: Checkout Journey Beauty product Guest User -Add product to Bag
  ...
  # And I select available colour "3" as "Juicy" from "colourDropDown"
...
@automated @ops-TABLET @checkout-J @Sno.-37
Scenario Outline: Navigate to payments page with saved address and delivery option as standard
...
@automated @ops-TABLET @checkout-J @Sno.-35
...
@automated @ops-TABLET @checkout-J @Sno.-36
...
Scenario: Navigate to delivery page, validate that Click & Collect delivery option is not available and slect Home delivery
  Then I should scroll to "checkoutButton" on "myBagPage"
  Then I navigate to delivery options as guest user
  Then I should see "disabledDeliveryType" as "Click & Collect" on "deliveryOptionPage"
  When I select home delivery and provide UK address details
  And I wait for "3000" milliseconds
  Then I should see "disabledDeliveryOption" as "Next Day DELIVERY" on "deliveryOptionPage"
...
@automated @ops-TABLET @checkout-J @Sno.-38
...
@automated @ops-TABLET @checkout-J @Sno.-39
...
@automated @ops-TABLET @checkout-J @Sno.-40
