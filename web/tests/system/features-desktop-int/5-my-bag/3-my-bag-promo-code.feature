...
@manual @DEBD-157
Scenario: Validate that the promo code should be removed when user changes the country and the promo code is not available in the new country
  Given I have at least one product applicable for promotion in My Bag
  When I enter valid promo code
  Then I should see "promotionAppliedNotification" exist on "myBagPage"
  When I "validate & click" country as "Austria" from "countryOptions" on "commonPage"
  Then I should not see "promotionAppliedNotification" on "myBagPage"

@manual @DEBD-157
Scenario: Validate that the promo code should be removed when user changes the country and the promo code is available in the new country
  Given I have at least one product applicable for promotion in My Bag
  When I enter valid promo code
  Then I should see "promotionAppliedNotification" exist on "myBagPage"
  When I "validate & click" country as "Canada" from "countryOptions" on "commonPage"
  Then I should see "promotionAppliedNotification" exist on "myBagPage"

@manual @DEBD-157
Scenario: Validate that the promo code should be removed when user changes the country with different currency and promo code is depending on currency
  Given I have at least one product applicable for promotion in My Bag
  When I enter valid promo code which is based on currency
  Then I should see "promotionAppliedNotification" exist on "myBagPage"
  When I "validate & click" country as "Austria" from "countryOptions" on "commonPage"
  Then I should not see "promotionAppliedNotification" on "myBagPage"

@manual @DEBD-157
Scenario: Validate that the promo code should be removed when user changes the country with same currency and promo code is depending on currency
  When I "validate & click" country as "Austria" from "countryOptions" on "commonPage"
  Given I have at least one product applicable for promotion in My Bag
  When I enter valid promo code which is based on currency
  Then I should see "promotionAppliedNotification" exist on "myBagPage"
  When I "validate & click" country as "Belgium" from "countryOptions" on "commonPage"
  Then I should see "promotionAppliedNotification" exist on "myBagPage"
