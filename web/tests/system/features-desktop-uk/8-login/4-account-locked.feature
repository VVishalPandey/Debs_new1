Feature: Test Debenhams account locked page


@automated @DEBD-1051 @DEBD-267 @Fixed
Scenario Outline: Navigate to Debenhams login page and validate login with incorrect password with account locked
  ...
  Then I should see "invalidPasswordMessage" as "Password incorrect - Please check your details and try again." on "loginPage"
  When I enter "<password>" in "passwordField" on "loginPage"
  And I click on "signInButton" on "loginPage"
  Then I should see "invalidPasswordMessage" as "Password incorrect - You have 2 attempts left before your account will be locked." on "loginPage"
  When I enter "<password>" in "passwordField" on "loginPage"
  And I click on "signInButton" on "loginPage"
  Then I should see "invalidPasswordMessage" as "Password incorrect - You have 1 attempts left before your account will be locked." on "loginPage"
  When I enter "<password>" in "passwordField" on "loginPage"
  And I click on "signInButton" on "loginPage"
...
Scenario Outline: Navigate to Debenhams account locked page navigation to forgotton password page on valid email address
  And I enter "<email>" in "emailAddressField" on "accountLockedPage"
  And I click on "resetPasswordButton" on "accountLockedPage"
