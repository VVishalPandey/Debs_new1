...
@automatedPudoSanity @DEBD-4039 @PUDO-MyBag @DEBD-3573 @DEBD-3222
...
Scenario: Validate the Delivery Landing page
    ...
    And I should see "clickCollectText1" as "Delivered to a ParcelShop of your choice, choose from over 4,500 locations, from £1.99." on "deliveryOptionPage"
...
@automatedPudoSanity @DEBD-4039 @PUDO
