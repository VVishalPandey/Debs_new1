...
@automated @PDP @Fixed @DEBD-112
Scenario: Validate that the zoomed image should be displayed on hovering on the main Image Container on PDP
  Given I navigate to "pdpPageWithMoreImages"
...
@automated @PDP @Fixed @DEBD-348 @awsManual
Scenario: Validate that video thumbnail is displayed on PDP page with few product images
  ...
  #And I should see "videoThumbnail" exist on "pdpPage"
  #Then I click on "videoThumbnail" on "pdpPage"
  #Then I should see "videoViewer" exist on "pdpPage"
...
@automated @DEBD-2742 @DEBD-2662
Scenario Outline: Validate the Image params and src on pdp as amplience
  ...
  And I verify "srcset" of "pdpMainHeroImage" containing "pdpMainImageParams" on "pdpPage"
  And I verify "srcset" of "pdbThumbImage" containing "pdpThumbImageParams" on "pdpPage"
...
|alcoholPDPURL|
|SofabedsPdpUrl|
|testBeautyLipGlowfPdpURL|
|LuggageGridBundleProductURL|
|pdpAIR|
|pdpYMAL|
|pdpCrossSale|
|ConcessionHome|
...
@automated @DEBD-2742 @DEBD-2662
Scenario: Validate the Image params and src on bundle suit pdp as amplience
  Given I navigate to "ListBundleProductUrl"
  Then I should see "pdpMainHeroImage" exist on "pdpPage"
  Then I should see "pdbThumbImage" exist on "pdpPage"
  And I verify "src" of "pdpMainHeroImage" containing "amplienceBaseUrl" on "pdpPage"
  And I verify "src" of "pdbThumbImage" containing "amplienceBaseUrl" on "pdpPage"
  And I verify "srcset" of "pdpMainHeroImage" containing "pdpMainImageParams" on "pdpPage"
  And I verify "srcset" of "pdbThumbImage" containing "bundlePdpThumbImageParams" on "pdpPage"
