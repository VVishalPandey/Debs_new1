...
@notAutomated @DEBD-349 @awsManual
Scenario: Validate that user able to click and add product which is visible under Customers who bought this also bought section
  ...
  Then I should see "customerWhoAlsoBoughtHeader" as "Customers who bought this item also bought" on "pdpPage"
...
@manual @DEBD-349 @awsManual
Scenario Outline: Validate the UI and product against desktop production for Customers who bought this also bought section wiht less than 4 products
  Given I navigate to "pdpPage"
  When I am in view of "customerWhoAlsoViewed" on "pdpPage"
  Then I can see the customers who bought this also bought carousel above the reviews section
