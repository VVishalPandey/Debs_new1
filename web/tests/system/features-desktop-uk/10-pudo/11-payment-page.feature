...
@notAutomated @DEBD-3231 @OrderNo-750000031842
Scenario: Verify that user is able to make payment using Beauty card + Promocode(SHO4) Free delivery STDPUDO (1.99) £20 minimal spend

@notAutomated @DEBD-3231 @OrderNo-750000032227
Scenario: Verify that user is able to make payment using Gift card + Promocode(SHO3) Free delivery PRMPUDO(3.99) no minimal spend

@notAutomated @DEBD-3231 @OrderNo-750000032222,750000032238
Scenario: Verify that user is able to make payment using Credit card + Promocode(SHO2) Free delivery STDPUDO(1.99) no minimal spend

@notAutomated @DEBD-3231 
Scenario: Verify that user is able to make payment using Gift card + Beauty card + Promocode(SHO4) Free delivery STDPUDO (1.99) £20 minimal spend

@notAutomated @DEBD-3231 @OrderNo-750000032240
Scenario: Verify that user is able to make payment using Gift card + Credit card + Promocode(SHO5) Free delivery PRMPUDO (3.99) £20 minimal spend

@notAutomated @DEBD-3231
Scenario: Verify that user is able to make payment using Beauty card + Credit card + Promocode(SHO4) Free delivery STDPUDO (1.99) £20 minimal spend

@notAutomated @DEBD-3231 @OrderNo-750000032386
Scenario: Verify that user is able to make payment using Debenhams Store card

@notAutomated @DEBD-3231 @OrderNo-750000032537
Scenario: Verify that user is able to make payment using V2 visa 3DS card

@notAutomated @DEBD-3231 @750000032239
Scenario: Verify that user is able to make payment using Gift card for Home delivery Order