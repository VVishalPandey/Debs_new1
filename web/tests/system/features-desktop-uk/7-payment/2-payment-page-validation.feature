...
@notAutomated @DEBD-171 @awsManual
...
@notAutomated @DEBD-1043 @DEBD-1034 @DEBD-294 @awsManual
...
@notAutomated @DEBD-1034 @DEBD-1033 @awsManual
...
@notAutomated @DEBD-1034 @awsManual
...
@notAutomated @DEBD-1034 @DEBD-1033 @DEBD-907 @awsManual
...
@manual @DEBD-1034 @DEBD-1033 @awsManual
Scenario: Validate the Saved Card on Payment Page For Registered User
  Then I should see "lastSavedCard" as selected by default
  And I can switch between the saved cards
