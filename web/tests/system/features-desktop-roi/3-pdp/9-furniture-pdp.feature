...
@automated @dataNA @DEBD-724 @DEBD-723
...
@automated @dataNA @DEBD-724
Scenario: Navigate to Sofa beds PDP and validate Fabric and Feet tabs
    Then I should verify "activeTab" "Fabric" to be highlighted "background-color" on "pdpPage"
    ...
    Then I should verify "activeTab" "Feet" to be highlighted "background-color" on "pdpPage"
...
Scenario Outline: Validate swatchis ordered when user enters address and selects a swatch
  ...
  Examples:
    ...
    | Vishal    | Malhotra | vmalhotra9918@sapient.com | Flat 31     | The Lock Building | High Street, Stratford | Dublin | D01F5P2   |
     
@notAutomated @DEBD-724
