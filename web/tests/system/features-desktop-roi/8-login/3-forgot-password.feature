...
@automated @DEBD-267
Scenario Outline: Validate that forgot password functionaity will not recognize the email address created in DOTINT for DOTCOM and viceversa
  Given I logout
  And I navigate to "forgotPasswordUrl"
  And I wait for "5000" milliseconds
  When I enter "<email>" in "emailAddressField" on "forgotPasswordPage"
