...
Scenario Outline: Navigate to PSP page
  ...
  Examples:
    ...
    | All knickers   | Lingerie     | Knickers            | /lingerie/knickers   |
    | Perfume        | Beauty       | Perfume             | perfume-aftershave   |
    | Beds           | Furniture    | Beds                | beds                 |
    | Boots          | Men          | Men's boots         | boots                |
...
Scenario: Validate DDN UI behavior
  ...
  And I should see the page should be greyedout below the DDN
...
Scenario: Validate colours of DDN
     ...
     Then I should see "Sale/Offer" in Red colours
     ...
     Then I should see blue colour instead of Red
