...
@automated @DEBD-520 @IssueEmptyEmail @Fixed
...
Scenario: Navigate to Debenhams home page and validate the footer links should work and open links in new tab
  ...
  Then I should see "copyrightDisclaimerText" as "Copyright © Debenhams Retail (Ireland). All rights reserved" on "commonPage"
