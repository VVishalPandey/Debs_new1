...
Scenario Outline: Navigate to Debenhams payment page and validate the gift card applied
  ...
  And I wait for "2000" milliseconds
  Then I should see "giftCardValue" as "<gift_card_value1>" on "paymentPage"
  # When I click on "giftCardApplyButton" on "paymentPage"


  Examples:
    | gift_card_number | gift_card_pin | gift_card_value | gift_card_number1 | gift_card_pin1 | gift_card_value1 |
    | 6335865046648696 | 0534          | € 1.00           | 6335865045855268 | 6936          | € 22.75         |
