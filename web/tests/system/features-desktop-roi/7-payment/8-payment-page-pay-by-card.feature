...
Scenario Outline: Validate the Pay By Card Accordion on Payment Page For Registered User
  ...
  And I verify "xlink:href" of "masterCardIconRoi" as "masterCardIconImage" on "paymentPage"
  And I verify "xlink:href" of "visaCardIconRoi" as "visaCardIconImage" on "paymentPage"
  And I verify "xlink:href" of "amexCardIconRoi" as "amexCardIconImage" on "paymentPage"
  And I verify "xlink:href" of "maestroCardIconRoi" as "maestroCardIconImage" on "paymentPage"
