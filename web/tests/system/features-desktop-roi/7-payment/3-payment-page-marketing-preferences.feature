...
Scenario Outline: Validate the Right Panel on the Payment Page For Registered User
  ...
  And I should see "termsConditionText" containing "By clicking 'Place Order and Pay', you are agree to our" on "paymentPage"
  And I should see "termsConditionLink" as "terms & conditions." on "paymentPage"
  And I should see "termsConditionText" containing "When you place an order, Debenhams & our third parties process your data so we can fulfil your order & improve your shopping experience; see" on "paymentPage"
  And I should see "privacyPolicyLinkPaymentPage" as "privacy policy" on "paymentPage"

Examples:
 |email                               |password        |
 |testpaymentautomation@test.com      |Sapient123      |
