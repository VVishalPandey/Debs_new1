...
Scenario Outline: Validate the page when Debenhams service center user entered invalid [First Name / Last name / Email User / PhoneNumber] in the registered customer search page
  ...
  Examples:
    ...
    |test    | Ragh    | abc@123.com | 0123456789  | No results found. Please retry. |
    |Balaji    | test    | abc@123.com | 0123456789  | No results found. Please retry. |
    |Balaji    | Ragh    | abc@12311.com | 0123456789  | No results found. Please retry. |
    |Balaji    | Ragh    | abc@123.com | 000000  | No results found. Please retry. |
