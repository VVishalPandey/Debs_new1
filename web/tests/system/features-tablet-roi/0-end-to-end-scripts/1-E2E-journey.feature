...
@automatedSanity @preprodSanity @e2e
Scenario: Validate the search result when user choose Tefal under Brand
  Then I should see "filterButton" exist on "pspPage"
  Then I click on "filterButton" on "pspPage"
  Then I "validate & click" option is available in "filterMenuList" as "Brand" on "pspPage"
  And I "validate & click" option from "filterMenuList" of "Brand"  as "filterSubMenuViewCheckboxList" as "Debenhams" on "pspPage"
  And I click on "closeButton" on "pspPage"
  Then I should see "headerText" containing "Home" on "pspPage"
  And I should see "pspHeader" as "Debenhams" on "pspPage"
  And I should see "url" contains "sale/home/debenhams"
...
Scenario: Validate the search result psp page when user apply filter Brand - Debut
  ...
  And I should see "searchText" as "Faith" on "pspPage"
  And I should see "url" contains "/sale/women/coats-jackets/faith"
