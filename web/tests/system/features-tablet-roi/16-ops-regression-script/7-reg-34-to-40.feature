...
@automated @ops-TABLET-ROI @checkout-J @Sno.-34
...
@automated @ops-TABLET-ROI @checkout-J @Sno.-35
...
@automated @ops-TABLET-ROI @checkout-J @Sno.-36
...
@automated @ops-TABLET-ROI @checkout-J @Sno.-37 @deprecated
...
@automated @ops-TABLET-ROI @checkout-J @Sno.-37
...
Scenario: Navigate to payments page with delivery option as Standard
  ...
  When I am in view of "headerText" on "paymentPage"
  When I "open" "orderSummaryAccordion" accordion on "paymentPage"
  And I should see "deliveryLeadTime" as "9 weeks" on "paymentPage"
  Then I validate the furniture colour on myBagPage

@automated @ops-TABLET-ROI @checkout-J @Sno.-38
...
@automated @ops-TABLET-ROI @checkout-J @Sno.-39
...
@automated @ops-TABLET-ROI @checkout-J @Sno.-40
