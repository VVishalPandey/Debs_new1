...
@automated @ops-TABLET-ROI @PSP @Sno.-15
...
@automated @ops-TABLET-ROI @PSP @Sno.-16
Scenario:Verify PSP, PSP Pricing, Sort by for the PSP page of Mother of the bride as per opsTC-13
  ...
  Then I should see "url" contains "women/mother-of-the-bride"
...
Scenario:Verify add and remove filter functionality on the PSP page for  Weddings > Wedding guest > Mother of the bride as per opsTC-13
  ...
  Then I should see "url" contains "women/debut/mother-of-the-bride"
  When I am in view of "filterButton" on "pspPage"
...
Scenario:Verify Price, Size Selector, SFL, Quantity on the PDP page of a product for  Weddings > Wedding guest > Mother of the bride as per opsTC-14
  ...
  And I wait for "2000" milliseconds
  And I am in view of "rewardPointsLink" on "pdpPage"
  When I click on "menuIcon" on "commonPage"
...
@automated @ops-TABLET-ROI @PDP @Sno.-17
...
Scenario: Verify the swatches, size selector, size guide, add to bag, reviews
  ...
  And I should see "rewardPointsLink" exist on "pdpPage"
...
Scenario: Validate the size guide link  exist and delivery/returs accodion exits
  ...
  And I click on "deliveryAndReturnsOptions" on "pdpPage"
...
@automated @ops-TABLET-ROI @PDP @Sno.-17
Scenario: Verify PSP page header and url
  Then I should see "url" contains "mantaray"
  And I should see "pspHeader" as "Mantaray" on "pspPage"

@automated @ops-TABLET-ROI @PDP @Sno.-18
...
@automated @ops-TABLET-ROI @PDP @Sno.-18
Scenario: Verify PSP page header and url
  And I should see "url" contains "quiz"
  Then I should see "pspHeader" as "Quiz" on "pspPage"

@automated @ops-TABLET-ROI @PDP @Sno.-19
...
@automated @ops-TABLET-ROI @PDP @Sno.-20
