...
Scenario: Navigate to Debenhams women -> dresses psp page and validate result and filters for categories women -> dresses -> casual dresses
  ...
  Then I "validate & click" option from "filterMenuList" of "Occasion" as "filterSubMenuInputList" as "Evening" on "pspPage"
  And I "validate & click" option is available in "filterMenuList" as "Occasion" on "pspPage"
  ...
  And I "validate & click" option is available in "filterMenuList" as "Brand" on "pspPage"
  Then  I "should see" "Debut" position "2" in filtered by
  And   I "should see" "Evening" position "3" in filtered by
  And I click on "closeIcon" on "pspPage"
  Then I should see "headerText" as "Dresses" on "pspPage"
  And  I should see "headerSubText" as "Debut,Evening" on "pspPage"
  And I should see "url" contains "women/dresses/debut/evening#filter"
  And I should validate "products" exist on "pspPage"
  When I click on "filterButton" on "pspPage"
  Then I should see "closeIcon" exist on "pspPage"
  And I should see "filterTitle" as "Dresses" on "pspPage"
  #And I "should see" "Dresses" position "1" in filtered by
  #And I "should see" "Debut" position "2" in filtered by
  #And I "should see" "Evening" position "2" in filtered by
  And I "validate" option is available in "filterMenuList" as "New arrivals" on "pspPage"
  And I "validate" option is available in "filterMenuList" as "Occasion" on "pspPage"
  And I "validate" option is available in "filterMenuList" as "Style" on "pspPage"
  And I "validate" option is available in "filterMenuList" as "Fit" on "pspPage"
  And I "validate" option is available in "filterMenuList" as "Brand" on "pspPage"
...
Scenario: Navigate to Debenhams beauty -> dress -> price -> Validate result and filters after applying filter for price
  ...
  When I click on position "1" "Under £10" under parentfilter "10" "Price"
  Then I should see "filterTitle" as "Dresses" on "pspPage"
  And I "should see" "Dresses" position "1" in filtered by
  And I "should see" "Under £10" position "2" in filtered by
  And I should see value of filter position "1" as "Under £10" under parentfilter "10" "Price" is not underlined
...
Scenario: Navigate to Debenhams beauty -> makeup psp page and validate result and filters after applying filter for brand -> Benefit & ARMANI (using search)
  ...
  And I click on position "23" "View" under parentfilter "2" "Brand"
  Then I should see "searchPanel" exist on "pspPage"
  And I enter "ARMANI" in "searchPanel" on "pspPage"
  Then I should see value as "ARMANI" in position "1" in filter search result under parentfilter "2"
  And I click on "ARMANI" in position "1" in filter search result under parentfilter "2"
...
Scenario: Navigate to Debenhams women -> dresses -> Evening dress -> brand -> Dorothy Perkins & Phase Eight psp page then validate result and filters after applying filter for size
  ...
  Then I should see "closeIcon" exist on "pspPage"
  And I should see "filterTitle" as "Dresses" on "pspPage"
  When I click to "expand" filter "Size" position "5"
  And I should see value of filter position "5" as "12" under parentfilter "5" "Size"
  When I click on position "5" "12" under parentfilter "5" "Size"
  And I should see "filterTitle" as "Dresses" on "pspPage"
  And I "should see" "Dresses" position "1" in filtered by
  And I "should see" "Dorothy Perkins" position "2  " in filtered by
  And I "should see" "Phase Eight" position "3" in filtered by
  And I "should see" "12" position "5" in filtered by
  When I click on "closeIcon" on "pspPage"
  Then I should see "headerText" as "Dresss" on "pspPage"
  And I should validate "products" exist on "pspPage"
...
@manual @DDAI-297
Scenario: Navigate to Debenhams women -> dresses -> casual dresses -> brand -> Red Herring psp page then validate result and filters after removing Phase Eight and then validate after clear all
  Given I navigate to "brandFilterDressesPspUrl"
  Then I should see "headerText" as "Dresses" on "pspPage"
  And I should validate "products" exist on "pspPage"
  When I click on "filterButton" on "pspPage"
  Then I should see "closeIcon" exist on "pspPage"
  And I should see "filterTitle" as "Dresses" on "pspPage"
  When I "remove" "Phase Eight" position "3" in filtered by
  Then I should see "headerText" as "Dresses" on "pspPage"
  ...
  And I "should see" "Dresses" position "1" in filtered by
  And I "should see" "Casual dresses" position "2" in filtered by
  And I "should see" "Red Herring" position "3" in filtered by
  When I click on "clearAllFilter" on "pspPage"
  Then I should see "url" contains "debenhams.com/webapp/wcs/stores/servlet/Navigate"
...
Scenario: Navigate to Debenhams women -> dresses -> dress psp page then validate result and filters after applying filter for size
  ...
  And I should see value of filter position "6" as "8" under parentfilter "3" "Size"
  When I click on position "6" "8" under parentfilter "3" "Size"
  And I "should see" "Shoes & boots" position "1" in filtered by
  And I "should see" "8" position "2" in filtered by
  When I click on "closeIcon" exist on "pspPage"
  Then I should see "url" contains "size_description"
  And I should see "headerText" as "Men's shoes & boots" on "pspPage"
  And  I should see "headerSubText" as "size 8" on "pspPage"
  And I should validate "products" exist on "pspPage"
  When I click on "filterButton" on "pspPage"
  When I click to "expand" filter "Size" position "3"
  And I should see value of filter position "4" as "7" under parentfilter "3" "Size"
  When I click on position "4" "7" under parentfilter "3" "Size"
  Then I "should see" "Shoes & boots" position "1" in filtered by
  And I "should see" "8" position "2" in filtered by
  And I "should see" "7" position "3" in filtered by
