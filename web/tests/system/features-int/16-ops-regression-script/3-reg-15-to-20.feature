...
@automated @ops-INT @Sno.-15
Scenario:Verify add and remove filter functionality on the PSP page for  Weddings > Mother of the bride > All mother of the brideTC-13
  ...
  # And I wait for "3000" milliseconds
  Then I should see "pspHeader" as "Mother of the bride" on "pspPage"
  # Then I should not see "searchText" on "pspPage"
...
@automated @ops-INT @Sno.-18
Scenario: Verify the add to bag, roundrobin
  And I should see "roundRobinSection" exist on "pdpPage"
  Then I should see "roundRobinHeaderText" as "Also in the range" on "pdpPage"
  And I click on "roundRobinImageMobile" on "pdpPage"
...
@automated @ops-INT
Scenario: Empty My Bag and navigate to home page
  When I click on "debenhamsLogo" on "commonPage"
  And I "Remove" "all" products from "myBagPage"
  And I click on "continueShoppingCTA" on "myBagPage"
