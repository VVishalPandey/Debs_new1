...
Scenario Outline: Navigate to Debenhams my bag page from above scenario and validate the discounts for above applied promo code
  ...
  Examples:
    | discount | promoCode | promoMessage  |
    | -$0.01   | PS01      | PS01: Applied |
...
Scenario Outline: Navigate to Debenhams my bag page from above scenario and validate the discounts after removing the promo code
  ...
  #hen I validate "discountValue" as "<discount>" on "myBagPage"
  ...
  Examples:
    | discount | promoCode | promoMessage  |
    | £0.00    | PS01      | PS01: Applied |

@automated @DDAI-348
Scenario Outline: Navigate to Debenhams my bag page and validate promo codes across countries with same currency
  Given I navigate to "womenDressesPdpUrlInt"
  #Then I should see "chooseyourcountry" as "Choose your country:" on "commonPage"
  #Then I click on "countryAustralia" on "commonPage"
  #Then I click on "countryselectorbtn" on "commonPage"
  ...
  Then I should see "chooseyourcountry" as "Choose your country:" on "commonPage"
  Then I click on "countryJapan" on "commonPage"
  Then I click on "countryselectorbtn" on "commonPage"
  Then I should see "promoCodeHeaderErrorMessage1Int" as "<promoHeaderErrorMessage>" on "myBagPage"
  And I should validate "promoCodeRemove" exist on "myBagPage"
  Then I remove all the items in my bag

  Examples:
    | promoCode | promoMessage  | promoHeaderErrorMessage                                                |
    | PS01      | PS01: Applied | PS01: Sorry, your basket is not eligible for this promotion click here |

@automated @DDAI-348
Scenario Outline: Navigate to Debenhams my bag page and validate promo codes across countries with differet  currency
  Given I navigate to "womenDressesPdpUrlInt"
  #Then I should see "chooseyourcountry" as "Choose your country:" on "commonPage"
  #Then I click on "countryAustralia" on "commonPage"
  #Then I click on "countryselectorbtn" on "commonPage"
  ...
  Then I click on "countrySelectorLink" on "commonPage"
  Then I should see "chooseyourcountry" as "Choose your country:" on "commonPage"
  Then I click on "countryFrance" on "commonPage"
  Then I click on "countryselectorbtn" on "commonPage"
  Then I should see "promoCodeHeaderErrorMessage1Int" as "<promoHeaderErrorMessage>" on "myBagPage"
  And I should validate "promoCodeRemove" exist on "myBagPage"
  Then I remove all the items in my bag
