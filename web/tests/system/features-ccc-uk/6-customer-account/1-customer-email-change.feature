...
@automated @DEBD-2317
Scenario: Validate CSR user is view customer detail after enacting the customer
  Given I logout
...
Scenario Outline: Validate CSR user is view customer detail after enacting the customer
  Given I logout
  When I am enacting as a customer using DSC
  And I click on "" on My Account details
  ...
  And I should see "DropCustomerSessionButton" on on "ccchomePage"
