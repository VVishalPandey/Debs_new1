...
Scenario Outline: Validate the Search details page when Debenhams service center user enters valid data
  ...
  Then I should see "youSearchedForResultLine1" containing "<firstname>" on "cccCustomerSearchPage"
  Then I should see "youSearchedForResultLine2" containing "<lastname>" on "cccCustomerSearchPage"
  Then I should see "youSearchedForResultLine3" containing "<useremail>" on "cccCustomerSearchPage"
  Then I should see "youSearchedForResultLine4" containing "<phoneno>" on "cccCustomerSearchPage"
  ...
  Then I should see "searchResultPostCode" containing "<postcode>" on "cccCustomerSearchPage"
  Then I should see "searchResult1stLineAddress" containing "<address>" on "cccCustomerSearchPage"
  
  Examples:
    |firstname | lastname | useremail     | phoneno  | postcode  | address |
    |    testr        |     store card      |       anne.deegan@debenhams.com        |   02075290701       |     SW4 0RH     |     Flat 14     |
